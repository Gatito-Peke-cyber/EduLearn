...
/* ===================================================
   ...
   =================================================== */
const FINAL_EXAM_COOLDOWN_DAYS = 0;
...
/* ===== COOLDOWN HELPERS ===== */
const COOLDOWN_KEY = "ingles_a1_final_exam_last_attempt";
...
/* ===== STATE ===== */
const STATE_KEY = "ingles_a1_state";
function getState() {
...
function syncXPToProfile(courseXP, finalApproved, finalGrade, examType, examGrade) {
  try {
    ...
    console.warn('syncXPToProfile error:', e);
  }
}
