/* =====================================================
   EduLearn — Primaria — JS v3.1 — Firebase sync fix
   CAMBIOS v3.1:
...
async function enrollCourse(id){
  ...
  if (uid) {
    try {
      ...
      console.warn('[Primaria] Error sync Firebase enrollCourse:', err);
    }
  }
...
async function enrollTemporal(tid){
  ...
  if (uid) {
    try {
      ...
      console.warn('[Primaria] Error sync Firebase enrollTemporal:', err);
    }
  }
